...
OKLCH-native, Display-P3-aware color picker for [shadcn/ui](https://ui.shadcn.com). Composable, accessible, gamut-aware. Drop into any Next.js + Tailwind v4 app with one CLI command.
